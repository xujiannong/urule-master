...
public class RepositoryServiceImpl extends BaseRepositoryService implements RepositoryService, ApplicationContextAware {
    ...
    //todo
    @Override
    public List<ProjectVariable> loadProjectLibraries(String paramString, Principal paramPrincipal) throws Exception
    {
//        Repository localRepository = loadRepository(paramString, paramPrincipal, false, new FileType[] { FileType.VariableLibrary, FileType.ParameterLibrary }, null);
//        List localList = localRepository.getRootFile().getChildren();
