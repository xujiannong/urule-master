...
public class CommonServletHandler extends BaseServletHandler {
    ...
    public List<Object> buildData(String var1) {
                ...
                for(int var7 = 0; var7 < var6; ++var7) {
                    ...
                    try {
                        ...
                        if (StringUtils.isEmpty(var10)) {
                            var11 = this.repositoryService.readFile(var8, (String)null);
                        } else {
                            var11 = this.repositoryService.readFile(var8, var10);
                        }

                        Element var12 = this.parseXml(var11);
                        Iterator var13 = this.deserializers.iterator();
        ...
        if (var3) {
            List var16 = this.builtInActionLibraryBuilder.getBuiltInActions();
            if (var16.size() > 0) {
